            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (congSel) {
                    case "1":
                        ...
                        break;
                    case "2":
                        SystemLogic.percussionStrips.add("Cng1");
                        SystemLogic.percussionStrips.add("Cng2");
                        break;
                    case "3":
                        SystemLogic.percussionStrips.add("Cng1");
                        SystemLogic.percussionStrips.add("Cng2");
                        SystemLogic.percussionStrips.add("Cng3");
                        break;
                ...
                switch (bongSel) {
                    case "1":
                        ...
                        break;
                    case "2":
                        SystemLogic.percussionStrips.add("Bng1");
                        SystemLogic.percussionStrips.add("Bng2");
                        break;
